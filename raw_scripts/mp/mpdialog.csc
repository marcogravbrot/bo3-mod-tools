...
REGISTER_SYSTEM( "mpdialog", &__init__, undefined )
...
{	
	...
	clientfield::register( "world", "boost_number", VERSION_SHIP, 2, "int", &set_boost_number, true, true );
	clientfield::register( "allplayers", "play_boost", VERSION_SHIP, 2, "int", &play_boost_vox, true, false );
}
