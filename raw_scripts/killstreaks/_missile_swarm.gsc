...
#precache( "string", "KILLSTREAK_MISSILE_SWARM_HACKED"  );
...
function swarm_killstreak_start( owner, killstreak_id )
{
	...
	owner killstreaks::play_killstreak_start_dialog( "missile_swarm", owner.pers["team"], killstreak_id );
...
function swarm_killstreak_watch_for_emp( owner, killstreak_id )
{
	...
	attacker challenges::addFlySwatterStat( GetWeapon( "emp" ) );
