...
function To set the desired amount of angles, make a K/V pair of script_int / 90 (or whatever angle you want).
...
REGISTER_SYSTEM( "elevator", &__init__, undefined )
...
function __init__()
{
	...
	array::thread_all(platforms_total,&define_elevator_parts);
}
...
function define_elevator_parts()
{
	...
	{
		array::thread_all(elevator_gates,&setup_elevator_gates, platform_name);
	}
