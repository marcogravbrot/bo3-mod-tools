...
REGISTER_SYSTEM( "missile_swarm", &__init__, undefined )
	
function __init__()
{
	level._effect["swarm_tail"] = "killstreaks/fx_hrpy_swrm_exhaust_trail_close";

	clientfield::register( "world", "missile_swarm", VERSION_SHIP, 2, "int",&swarm_start, !CF_HOST_ONLY, !CF_CALLBACK_ZERO_ON_NEW_ENT );
}
