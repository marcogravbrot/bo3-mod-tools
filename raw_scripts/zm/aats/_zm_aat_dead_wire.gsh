...
//
#define ZM_AAT_DEAD_WIRE_CF_NAME_ZAP				ZM_AAT_DEAD_WIRE_NAME + "_zap"
#define ZM_AAT_DEAD_WIRE_CF_NAME_ZAP_VEH			ZM_AAT_DEAD_WIRE_NAME + "_zap_vehicle"
...
#define ZM_AAT_DEAD_WIRE_DELAY						.25
#define ZM_AAT_DEAD_WIRE_RANGE						120
#define ZM_AAT_DEAD_WIRE_MAX_ARCS					8
#define ZM_AAT_DEAD_WIRE_ZOMBIE_ZAP_FX				"zombie/fx_tesla_shock_zmb"
#define ZM_AAT_DEAD_WIRE_ZOMBIE_SLOW_TOTAL_TIME		1

#define ZM_AAT_DEAD_WIRE_ZAP_SOUND					"wpn_aat_deadwire_impact"
