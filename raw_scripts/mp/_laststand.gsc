...
REGISTER_SYSTEM( "laststand", &__init__, undefined )
...
function PlayerLastStand( eInflictor, attacker, iDamage, sMeansOfDeath, weapon, vDir, sHitLoc, psOffsetTime, delayOverride )
{
	...
	slot = self ability_util::gadget_slot_for_type( GADGET_TYPE_RESURRECT );
	self GadgetStateChange( slot, self.resurrect_weapon, GADGET_ACTION_PRIMED );
